...
Plans:
- [x] 01-01-PLAN.md - Backend foundation: schema, provider/schedule APIs, trigger pipeline, lifecycle persistence
- [x] 01-02-PLAN.md - Operator UI: config/schedule/manual-run/history views wired to backend contracts
**Success Criteria**:
